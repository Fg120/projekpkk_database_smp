		...
		<div class="container-tight py-6">
			...
			<div class="card-body">
				<div class="text-center mb-4">
					<!-- <a href="."><img src="<?= base_url(); ?>assets/images/logo.jpg" height="36" alt=""></a> -->
					<h1>Database</h1>
				</div>
				<?= $this->session->flashdata('msg'); ?>
				<h2 class="card-title text-center mb-4">Sign in ke akun anda</h2>
				<div class="mb-3">
					<label class="form-label">Username</label>
					<input autofocus onfocus="this.select()" value="<?= set_value('username'); ?>" name="username" type="text" class="form-control" placeholder="Masukkan Username">
					<?= form_error('username'); ?>
				</div>
				<div class="mb-2">
