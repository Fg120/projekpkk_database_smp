		...
		<div class="card card-outline card-primary shadow-sm">
			...
			<div class="card-header">
				...
				<div class="card-tools">
					...
					<a href="<?= base_url('guru/tambah'); ?>" class="btn btn-primary btn-xs"><i class="fa fa-plus"></i>Tambah Guru</a>
				</div>
			</div>
						...
						?>
							<tr>
								...
								<td class="text-right" width="180">
									<div class="btn-group">
										<a href="<?= base_url('guru/edit/') . $row->id ?>" class="btn btn-default btn-sm btn-edit"><i class="fa fa-edit"></i> Edit </a>
										<a href="<?= base_url('guru/delete/') . $row->id; ?>" onclick="return confirm('Yakin ingin hapus ?');" class="btn btn-default btn-sm"><i class="fa fa-trash"></i> Delete</a>
									</div>
								</td>
							</tr>
						<?php endforeach; ?>
